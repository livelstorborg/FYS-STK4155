...
class GMVAE:
  ...
  def __init__(self, args):
    ...
    # optimizer config
    self.optimizer_type = getattr(args, 'optimizer', 'Adam')
    self.optimizer_params = getattr(args, 'optimizer_params', {})
  ...
  def train(self, train_loader, val_loader):
    ...
    """
    # Create optimizer dynamically based on config
    optimizer_class = getattr(optim, self.optimizer_type)
    optimizer_params = {'lr': self.learning_rate, **self.optimizer_params}
    optimizer = optimizer_class(self.network.parameters(), **optimizer_params)
