...
# =============================================================================
#                    LEARNING RATES (Stochastic needs lower rates)
# =============================================================================
...
for opt in ['sgd', 'sgd_momentum', 'sgd_adagrad', 'sgd_rmsprop', 'sgd_adam']:
    ...
    for batch_size in batch_sizes:
        ...
        analysis = RegressionAnalysis(
            ...
            lam=lam,
            eta=learning_rates[opt],
            num_iters=None,  # Not used for SGD
            n_epochs=n_epochs,
...
print("\n\n" + "="*80)
print("SUMMARY: TIME TO CONVERGENCE - OLS")
print("="*80)

df_model = df_results[df_results['Model'] == 'OLS'].copy()
