...
analysis = RegressionAnalysis(data, degree=degree, lam=lam, eta=eta, num_iters=num_iters)
...
X_full_norm, _, _ = scale_data(X_full, y_true)  # normalize consistently with full dataset
...
solutions = [y_pred_ols_analytical, y_pred_ols_gd, y_pred_ridge_analytical, y_pred_ridge_gd, y_true]
