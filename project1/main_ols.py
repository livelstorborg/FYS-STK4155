...
for N in sample_sizes:
    ...
    for deg in degrees:
        ...
        X_train, X_test, y_train, y_test, x_train, x_test = train_test_split(X_norm, y_centered, x, test_size=0.2, random_state=42)
    ...
    for deg in degrees:
        analysis = RegressionAnalysis(data_splits[deg], degree=deg, lam=None, eta=None, num_iters=None)
    ...
    if N == 1000:
        ...
        theta_evolution_ols(degrees, theta1_evolution, sample_size=1000)  # Evolution of theta1 for N=1000 (a)
